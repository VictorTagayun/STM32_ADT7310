...
void VT_Reset_ADT7310(void)
{
	...
	uint8_t ADT7310_reset[4] = {0xff, 0xff, 0xff, 0xff}, num_data = 4;
...
{
	SPI_TXRX_stat = 0;
	uint8_t ADT7310_TX[3], ADT7310_RX[3], num_data;
...
{
	SPI_TXRX_stat = 0;
	uint8_t ADT7310_TX[3], ADT7310_RX[3];
